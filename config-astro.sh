...
echo " Il est téléchargeable depuis le dépôt github https..."
echo ""
echo -e '\033[0;35m'
...
echo ""
echo "Instructions: - exécutez ce script en tant que superutilisateur"
echo " - Répondez aux questions posées par le script en tapant 'y' ou 'N' puis en appuyant sur la touche 'entrée'."
echo " - Ne coupez pas le script en cours d'exécution (Temps estimé: X min)"
echo ""
